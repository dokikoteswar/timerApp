...
const startTimerButton = document.getElementById('setNow');
...
startTimerButton.addEventListener('click', () => {
    ...
    const hours = parseInt(document.getElementById('hh').value) || 0;
    const minutes = parseInt(document.getElementById('mm').value) || 0;
    const seconds = parseInt(document.getElementById('ss').value) || 0;
...
function createTimer(totalSeconds) {
    ...
    timerContainer.classList.add('timerConainer');
    ...
    function updateTimerDisplay() {
        ...
        if (totalSeconds <= 0) {
            ...
            timeLeftElement.style.backGround =  'red';
            let parentTimer = timeLeftElement.parentNode
            parentTimer.style.backgroundColor = "#f0f757";
            ...
            console.log(timeLeftElement.value = '');
